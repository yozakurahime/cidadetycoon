...
function GetPlayerVehicleFilter(source, garageName)
    ...
    local isPublicGarage = not garage.groups and garage.type ~= GarageType.DEPOT
    filter.garage = not garage.skipGarageCheck and not isPublicGarage and garageName or nil
    return filter
end
