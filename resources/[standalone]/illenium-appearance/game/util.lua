...
local function setPlayerModel(model)
    -- Guard against the common invalid hash '924347437' (result of double-hashing a stringified hash)
    if model == 924347437 or model == "924347437" then
        print("^1[illenium-appearance] BLOCKING invalid model 924347437. Falling back to freemode male.^7")
