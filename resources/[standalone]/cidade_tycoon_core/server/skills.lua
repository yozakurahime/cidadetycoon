...
-- In-memory cache for modifiers to avoid constant complex logic
local ModifiersCache = {}
...
local function getSkillModifierForCitizen(citizenId, modifierName)
    local profile = exports.cidade_tycoon_core:GetProfileByCitizenId(citizenId)
    if not profile then return 1.0 end
