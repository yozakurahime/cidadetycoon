...
Config.contratos = {
	...
	['preco_por_km_min'] = 95,				-- Minimum price per kilometer of the contract
	['preco_por_km_max'] = 180,				-- Maximum price per kilometer of the contract
