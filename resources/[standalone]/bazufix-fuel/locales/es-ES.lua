...
Config.Locales['es-ES'] = {
    ...
    -- Admin Panel
    admin_badge                 = 'Panel de Administración',
    ...
    admin_search_placeholder    = 'Buscar por nombre de estación o propietario...',
    ...
    admin_btn_assign            = 'Asignar propietario',
    admin_btn_remove            = 'Eliminar propietario',
    admin_assign_title          = 'Asignar propietario',
    admin_assign_label          = 'ID del jugador (Server ID)',
